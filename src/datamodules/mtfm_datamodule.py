...
from utils import average_word2vec

average_word2vec_tensor = torch.tensor(average_word2vec, dtype=torch.float32)


class MTFMDataModule(LightningDataModule):
    ...
    def __init__(
        ...
        super(MTFMDataModule, self).__init__()
